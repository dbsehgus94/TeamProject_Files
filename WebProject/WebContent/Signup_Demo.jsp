	...
	<div class="container">
		<div class="login-form">
			...
			<table id="table">
				<tr>
					<td id="title">아이디</td>
					<td><input type="text" name="id" size="30" maxlength="10">
						<input type="button" value="중복확인"></td>
				</tr>

				<tr>
					<td id="title">비밀번호</td>
					<td><input type="password" size="30" name="pw" id="pw"
						maxlength="16" placeholder="8~16자리"></td>
				</tr>

				<tr>
					<td id="title">비밀번호 확인</td>
					<td><input type="password" size="30" name="pw_check"
						id="pw_check" maxlength="16" placeholder="8~16자리"></td>
				</tr>
				<tr>
					<td></td>
		...
		<div class="sign_button">
			<button id="sign_button" type="submit" value="Sign_up"
