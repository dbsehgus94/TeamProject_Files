			...
			<table id="table">
				<tr>
					...
					<td><input type="text" id="id" name="id" size="30"
						maxlength="16"> <input type="button" value="중복확인"
						onclick="location.href='IdCheck_window.jsp'"></td>
				</tr>
				...
				<tr>
					<td id="title">휴대전화</td>
					<td><input id="phone" type="tel" size="3" name="phone_1"
						maxlength="3" placeholder="010" /> <input id="phone" type="tel"
						size="4" name="phone_2" maxlength="4" placeholder="1234" /> <input
						id="phone" type="tel" size="4" name="phone_3" maxlength="4"
						placeholder="5678" /></td>
				</tr>
				<tr>
					<td id="title">주소</td>
